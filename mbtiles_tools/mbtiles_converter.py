...
class MBTilesConverter:
    ...
    def convert_directory_to_mbtiles(self, input_dir, mbtiles_path, scheme='tms', max_workers=None, zoom_levels=None):
        """
        将目录结构转换为MBTiles
        ...
        Args:
            ...
            scheme: 输入目录的坐标系统 ('xyz' 或 'tms')，默认为'tms'
            max_workers: 最大线程数
        ...
        if scheme not in ['xyz', 'tms']:
            print(f"✗ 无效的坐标系统: {scheme}，默认使用 'tms'")
            scheme = 'tms'
    ...
    def compare_mbtiles(self, mbtiles_file1, mbtiles_file2):
        ...
        try:
            ...
            # 获取scheme并验证
            scheme1 = metadata1.get('scheme', 'tms').lower()
            ...
            # 获取scheme并验证
            scheme2 = metadata2.get('scheme', 'tms').lower()
    ...
    def analyze_mbtiles(self, mbtiles_path):
        ...
        try:
            ...
            # 获取scheme
            scheme = metadata.get('scheme', 'tms').lower()
            print(f"\n✓ 坐标系统: {scheme.upper()}")
